...
public class N1475_Final_Prices_With_a_Special_Discount_in_a_Shop {
    public int[] finalPrices(int[] prices) {
        ...
        for (int i = 0; i < prices.length; i++) {
            ...
            for (int j = i + 1; j < prices.length; j++) {
                if (finalPrices[i] > prices[j]) {
                    finalPrices[i] = finalPrices[i] - prices[j];
                    break;
                } else if (finalPrices[i] == prices[j]) {
                    finalPrices[i] = 0;
                    break;
                }
            }
    ...
    public int[] finalPricesLee(int[] A) {
